 ...
 * site config
 * */
//$config['site_url'] = 'http://192.168.0.32/regmaster/';

/*
 * default metas
 * */
$config['site_meta_title'] = 'Система регистрации пользователей';
...
/*PreSelect*/
$config['select'] = array(
	'templates/brutality/js/selectize/selectize.js',
	'templates/brutality/js/selectize/script.js',
);
$config['typeahead'] = array(
	'templates/brutality/js/typeahead/typeahead.js',
);
